...
const uploadOncloudinary = async (localFilePath) => {
  try {
    ...
    fs.unlinkSync(localFilePath); //remove the locally saved file in the server Synchronously means its important verna currupted and unwanted files be mtlb me save rahengi server pe.
    return null;
  }
};
